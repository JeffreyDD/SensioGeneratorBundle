    ...
    protected function configure()
    {
        $this
            ->setDefinition(array(
                ...
                new InputOption('targetbundle', '', InputOption::VALUE_REQUIRED, 'The bundle name to create generate to'),
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($input->getOption('targetbundle')) {
            $targetbundle = Validators::validateBundleName($input->getOption('targetbundle'));
        }
